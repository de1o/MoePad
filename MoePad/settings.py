...
DATABASES = {
    'default': {
        ...
        'NAME': '/'.join([os.getcwd(), 'MoePad.db']),                       # Or path to database file if using sqlite3.
...
SECRET_KEY = '+y^3el(=$s(ydre4zxu#bfhabjt*)hiwrvbga=@qpip8&amp;l!_=s'
...
ROOT_URLCONF = 'MoePad.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'MoePad.wsgi.application'
